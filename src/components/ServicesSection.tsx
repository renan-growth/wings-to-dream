...
const services = [
  { icon: Sparkles, title: "Cruzeiros", desc: "Viva dias inesquecíveis em alto-mar com um cruzeiro planejado especialmente para o seu perfil." },
  ...
  { icon: Home, title: "Hospedagem", desc: "Acomodações selecionadas nas melhores localizações e de acordo com o pefil de cada cliente." },
  { icon: Compass, title: "Experiências Exclusivas", desc: "​Sua viagem, do seu jeito, com experiências exclusivas e atendimento totalmente personalizado" },
];

const ServicesSection = () => {
  return (
    <section id="servicos" className="py-20 md:py-28 <section id="servicos" className="py-20 md:py-28 bg-[hsl(205,70%,18%)]">">
